...
public class Wall extends GameObject {      //NOTE: this class is only used to handle border(unbreakable) walls and background walls(it handles both, because they have identical functionality), breakable walls are handled in the BreakableWalls class
